...
class AboutKeywordArguments < Neo::Koan
  ...
  # Ans:
  # if the initial argument does NOT have a default value then it is a required argument and the default values
  # for subsequent arguments are never reached by the interpreter
